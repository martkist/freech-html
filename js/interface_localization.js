...
if(preferredLanguage == "en"){
    ...
    wordset = {
      ...
      "Martkist address": "Martkist address",
      "Language": "Language",
      "Sound": "Sound",
      "Users": "Users",
...
if(preferredLanguage == "es"){
    ...
    wordset = {
      ...
      "website": "website",
      "Tox address": "Tox address",
      "Martkist address": "Dirección Martkist",
      "Language": "Idioma",
      "Sound": "Sonido",
      "Users": "Usuarios",
      'dm_copy_outgoing_to_self': 'Copy outgoing messages to self',
...
if(preferredLanguage == "uk"){
    ...
    wordset = {
      ...
      "Martkist address": "Адреса Martkist",
      "Language": "Мова",
      "Sound": "Звук",
      "Users": "Користувачі",
...
if(preferredLanguage == "ru"){
    ...
    wordset = {
      ...
      'new_account_briefing': 'Новая учётная запись создана и сейчас распространяется по сети. '
       ...
       "Martkist address": "Martkist адрес",
       "Language": "Язык",
       "Sound": "Звук",
       "Users": "Пользователи",
...
if(preferredLanguage == "tr"){
    ...
    wordset = {
      ...
      "Martkist address": "Martkist adresi",
      "Language": "Dil",
      "Sound": "Ses",
      "Users": "Kullanıcılar",
...
if(preferredLanguage == "cs"){
    ...
    wordset = {
      ...
      "Martkist address": "Adresa pro Martkist",
      "Language": "Jazyk",
      "Sound": "Zvuky",
      "Users": "Uživatelé",
